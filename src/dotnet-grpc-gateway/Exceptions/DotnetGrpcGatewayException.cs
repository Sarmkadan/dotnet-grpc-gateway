...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DotnetGrpcGatewayException"/> class.
    /// </summary>
    public DotnetGrpcGatewayException() { }

    /// <summary>
    /// Initializes a new instance of the <see cref="DotnetGrpcGatewayException"/> class with a specified error message.
    /// </summary>
