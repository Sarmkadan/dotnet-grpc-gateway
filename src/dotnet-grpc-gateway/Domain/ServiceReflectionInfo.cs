...
public class ServiceReflectionInfo
{
    ...
    /// <summary>Returns a concise, informative representation of this instance.</summary>
    public override string ToString() =>
        $"ServiceReflectionInfo {{ ServiceId = {ServiceId}, ServiceName = {ServiceName}, ServiceFullName = {ServiceFullName}, Methods = {Methods}, ReflectedAt = {ReflectedAt}, IsAvailable = {IsAvailable} }}";
}
